...
<div class="sidebar bg-light">
    <div class="list-group list-group-flush">
        ...
        <a href="/trioAdmin/stock" class="list-group-item list-group-item-action bg-light text-dark">재고 관리</a>
        <a href="/trioAdmin/addItem" class="list-group-item list-group-item-action bg-light text-dark">상품 등록</a>
        <a href="/trioAdmin/stores" class="list-group-item list-group-item-action bg-light text-dark">입고 등록</a>
        <a href="/trioAdmin/storesList" class="list-group-item list-group-item-action bg-light text-dark">입고 내역</a>
        <a href="/trioAdmin/purchase" class="list-group-item list-group-item-action bg-light text-dark">발주 등록</a>
        <a href="/trioAdmin/purchaseList" class="list-group-item list-group-item-action bg-light text-dark">발주 내역</a>
